...
--CUSTOM: Added flooring
function lume.random(a, b, f)
  if not a then a, b = 0, 1 end
  if not b then b = 0 end
  local v = a + math_random() * (b - a)
  return (f and math_floor(v) or v)
end
...
--CUSTOM FUNCTIONS
--These functions are self added and are not part of the library.
